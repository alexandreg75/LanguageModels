...
REWRITE_PROMPT = """\
SYSTEM:
Tu réécris UNE requête de recherche car la première a renvoyé une evidence peu exploitable.
...
def rewrite_query(state: AgentState) -> AgentState:
    ...
    # garder court (max ~12 mots demandé) → on tronque “soft”
    q2 = " ".join(q2.split()[:12]).strip() or q1
