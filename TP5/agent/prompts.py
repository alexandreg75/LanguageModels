...
Tu respectes STRICTEMENT les contraintes et tu ne rajoutes aucune clé.
...
{{
  ...
  "retrieval_query": "règles validation UE règlement scolarité",
  "rationale": "Email administratif nécessitant des informations fiables."
}}
"""
